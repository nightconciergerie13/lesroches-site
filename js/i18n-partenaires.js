...
var LR_I18N = {
  ...
  fr: {
    ...
    pillar1_title:      'Commission 20 %',
    pillar1_body:       'Tarif net partenaire direct, sans frais cachés ni commissions additionnelles. Ce que vous voyez est ce que vous payez.',
    ...
    live_desc:    'Accédez au calendrier de disponibilités connecté à notre système de réservation. Les prix sont affichés à −20 % du tarif public, avec les nuits minimum par période. Mis à jour automatiquement à chaque modification de notre part.',
    ...
    faq2_a: 'Aucun. Le tarif net partenaire affiché dans notre calendrier est le prix final que vous payez. La commission de 20 % est déjà intégrée dans ce tarif : vous vendez le prix public à vos clients, la différence est votre marge. Pas de frais de dossier, pas de frais cachés.',
    ...
    search_sub:         'Sélectionnez vos dates pour voir les tarifs partenaires (-20%) et la disponibilité des 6 villas en temps réel.',
  ...
  en: {
    ...
    pillar1_title:      '20% Commission',
    pillar1_body:       'Direct net partner rate, no hidden fees or additional commissions. What you see is what you pay.',
    ...
    live_desc:    'Access the availability calendar connected to our booking system. Prices shown at −20% of public rate, with minimum nights per period. Automatically updated whenever we make changes.',
    ...
    faq2_a: 'None. The net partner rate shown in our calendar is the final price you pay. The 20% commission is already built into this rate: you sell the public price to your clients, and the difference is your margin. No admin fees, no hidden charges.',
    ...
    search_sub:         'Select your dates to see partner rates (−20%) and real-time availability for all 6 villas.',
  ...
  es: {
    ...
    pillar1_title:      'Comisión del 20%',
    pillar1_body:       'Tarifa neta directa para socios, sin tarifas ocultas ni comisiones adicionales. Lo que ven es lo que pagan.',
    ...
    live_desc:    'Acceda al calendario de disponibilidad conectado a nuestro sistema de reservas. Los precios se muestran con un −20% sobre la tarifa pública, con las noches mínimas por período. Actualización automática con cada cambio de nuestra parte.',
    ...
    faq2_a: 'Ninguna. La tarifa neta del socio que aparece en nuestro calendario es el precio final que paga. La comisión del 20% ya está incluida en esa tarifa: usted vende el precio público a sus clientes, y la diferencia es su margen. Sin gastos de gestión, sin cargos ocultos.',
    ...
    search_sub:         'Seleccione sus fechas para ver las tarifas de socio (−20%) y la disponibilidad en tiempo real de las 6 villas.',
