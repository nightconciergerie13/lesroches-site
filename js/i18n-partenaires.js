...
var LR_I18N = {
  ...
  fr: {
    ...
    live_desc:    'Accédez au calendrier de disponibilités connecté à notre système de réservation. Les prix sont affichés à −12 % du tarif public, avec les nuits minimum par période. Mis à jour automatiquement à chaque modification de notre part.',
    ...
    faq2_a: 'Aucun. Le tarif net partenaire affiché dans notre calendrier est le prix final que vous payez. La commission de 12 % est déjà intégrée dans ce tarif : vous vendez le prix public à vos clients, la différence est votre marge. Pas de frais de dossier, pas de frais cachés.',
    ...
    search_sub:         'Sélectionnez vos dates pour voir les tarifs partenaires (-12%) et la disponibilité des 6 villas en temps réel.',
  ...
  en: {
    ...
    pillar1_title:      '12% Commission',
    pillar1_body:       'Net partner rate at −12% off public price. You're free to keep the margin or pass savings on to your clients. No hidden fees.',
    ...
    live_desc:    'Access the availability calendar connected to our booking system. Prices shown at −12% of public rate, with minimum nights per period. Automatically updated whenever we make changes.',
    ...
    faq2_a: 'None. The net partner rate shown in our calendar is the final price you pay. The 12% commission is already built into this rate: you sell the public price to your clients, and the difference is your margin. No admin fees, no hidden charges.',
    ...
    search_sub:         'Select your dates to see partner rates (−12%) and real-time availability for all 6 villas.',
  ...
  es: {
    ...
    live_desc:    'Acceda al calendario de disponibilidad conectado a nuestro sistema de reservas. Los precios se muestran con un −12% sobre la tarifa pública, con las noches mínimas por período. Actualización automática con cada cambio de nuestra parte.',
    ...
    faq2_a: 'Ninguna. La tarifa neta del socio que aparece en nuestro calendario es el precio final que paga. La comisión del 12% ya está incluida en esa tarifa: usted vende el precio público a sus clientes, y la diferencia es su margen. Sin gastos de gestión, sin cargos ocultos.',
    ...
    search_sub:         'Seleccione sus fechas para ver las tarifas de socio (−12%) y la disponibilidad en tiempo real de las 6 villas.',
